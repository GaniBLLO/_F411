...
void GPIO_LCD_Init(void){
	...
	//Clear output in register
	GPIOA->ODR = 0x0;
	GPIOB->ODR = 0x0;

	/* SPI1 PINS
	 * Alternative func moder = |1|0|;
	 * Highspeed = |1|1|;
	 * SPI_1 = AF5
	 * MOSI	-> PA7
	 * MISO	-> PA6
...
void ILI9341_Init() {
	...
	ILI9341_SPI_PORT.SpiREGS = SPI1;
	ILI9341_SPI_PORT.init = ttt;
	ILI9341_SPI_PORT.init(&ILI9341_SPI_PORT);
